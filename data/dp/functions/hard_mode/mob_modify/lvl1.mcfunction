...
execute if entity @s[type=#dp:all_hostiles] store result entity @s Attributes[{Name:"minecraft:generic.max_health"}].Base double 1.1 run data get entity @s Attributes[{Name:"minecraft:generic.max_health"}].Base
